...
# FUNCIÓN MEJORADA PARA GRÁFICOS COMPLEMENTARIOS CON MODELOS
def crear_graficos_complementarios(df, titulo_sufijo=""):
    """Crear gráficos complementarios con los mejores modelos ajustados"""
    ...
    # Graficar puntos
    ax1.scatter(x_vel, y_vel, color='green', s=60, alpha=0.7, edgecolors='black', linewidth=0.5)
    ...
    if modelo_vel and r2_vel > 0:
        ...
        if modelo_vel == 'Logarítmico':
            y_pred_vel = funcion_vel(x_range_vel + 0.001, *params_vel)  # Ajuste para log
        else:
            y_pred_vel = funcion_vel(x_range_vel, *params_vel)
        ax1.plot(x_range_vel, y_pred_vel, 'green', linewidth=2, 
    ...
    ax2.scatter(x_area, y_area, color='red', s=60, alpha=0.7, edgecolors='black', linewidth=0.5)
    ...
    if modelo_area and r2_area > 0:
        ...
        ax2.plot(x_range_area, y_pred_area, 'red', linewidth=2, 
    ...
    ax3.scatter(x_rh, y_rh, color='purple', s=60, alpha=0.7, edgecolors='black', linewidth=0.5)
    ...
    if modelo_rh and r2_rh > 0:
        ...
        ax3.plot(x_range_rh, y_pred_rh, 'purple', linewidth=2, 
    ...
    ax4.scatter(x_caudal, y_caudal, color='orange', s=60, alpha=0.7, edgecolors='black', linewidth=0.5)
    ...
    if modelo_caudal and r2_caudal > 0:
        ...
        ax4.plot(x_range_caudal, y_pred_caudal, 'orange', linewidth=2, 
