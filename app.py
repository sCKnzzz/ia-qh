                    ...
                    if st.button("🚀 Procesar Aforos", type="primary"):
                        with st.spinner("Procesando aforos y generando curvas..."):
                            try:
                                ...
                                curvas, clasificados = modelo.predecir_curvas(df_subido, incluir_alto_rh=True)
                                    ...
                                    if st.button("🔄 Recalcular excluyendo GRUPO_ALTO_RH"):
                                        with st.spinner("Recalculando curvas sin GRUPO_ALTO_RH..."):
                                            try:
                                                ...
                                                curvas_sin_alto_rh, clasificados_sin_alto_rh = modelo.predecir_curvas(df_subido, incluir_alto_rh=False)
...
# ... (el resto del código para Ingreso Manual y Curvas se mantiene similar pero con la misma lógica)
